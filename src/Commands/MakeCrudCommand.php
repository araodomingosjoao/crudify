...
namespace AraoDomingos\Crudify\Commands;
...
class MakeCrudCommand extends Command
{
    ...
    protected function createModel($name, $fields, $relations, $softDeletes = false)
    {
        Artisan::call('make:model', ['name' => $name]);

        $softDeletesTrait = $softDeletes ? "use Illuminate\\Database\\Eloquent\\SoftDeletes;\n\n" : '';
    ...
    protected function createMigration($name, $fields, $relations, $softDeletes = false)
    {
    ...
    protected function getMigrationFields($fields, $useSoftDeletes)
    {
        $fieldsArray = explode(',', $fields);
        $migrationFields = [];
